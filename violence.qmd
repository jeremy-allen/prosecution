...
# fix the mix of numeric and character in the # killed column and case name capitalizations
df <- df |> 
    mutate(
...
ggplot() +
    ...
    geom_text(data = presidents, aes(x = year, y = 70, label = president), 
...
ggplot() +
    geom_vline(data = presidents, aes(xintercept = year), 
               color = "black", linetype = "dashed", alpha = 0.7) +
    geom_text(data = presidents, aes(x = year, y = 7, label = president), 
              vjust = 1.5, hjust = 0, angle = 90, size = 3, color = "black") +
...
ggplot() +
    geom_vline(data = presidents, aes(xintercept = year), 
               color = "black", linetype = "dashed", alpha = 0.7) +
    geom_text(data = presidents, aes(x = year, y = 50, label = president), 
              vjust = 1.5, hjust = 0, angle = 90, size = 3, color = "black") +
...
ggplot() +
    geom_vline(data = presidents, aes(xintercept = year), 
               color = "black", linetype = "dashed", alpha = 0.7) +
    geom_text(data = presidents, aes(x = year, y = 8, label = president), 
              vjust = 1.5, hjust = 0, angle = 90, size = 3, color = "black") +
